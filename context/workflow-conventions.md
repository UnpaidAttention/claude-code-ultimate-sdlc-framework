...
1. READ the agent file at `~/.claude/skills/antigravity/agents/{agent-name}.md`
...
**Always read first:**
- `.antigravity/council-state/{council}/WORKING-MEMORY.md` — Current session state
- `.antigravity/council-state/{council}/run-tracker.md` — Check for multi-run mode (Development only)
