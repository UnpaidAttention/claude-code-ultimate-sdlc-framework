...
# /sdlc-validate-gate-s2

This command invokes the `sdlc-validate-gate-s2` workflow skill. Use the Skill tool to load the full workflow:

```
Skill: sdlc-validate-gate-s2
```
