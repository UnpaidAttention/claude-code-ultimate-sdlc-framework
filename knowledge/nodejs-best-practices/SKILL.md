...
- [ ] **JWT verification**: Verify signature, issuer, audience, expiry
- [ ] **Rate limiting**: All endpoints, stricter on auth (5/hour)
- [ ] **Security headers**: Helmet.js configured properly
- [ ] **HTTPS**: Everywhere in production
- [ ] **CORS**: Properly restricted (specific origins only)
...
// ✅ ALWAYS: Generic to client, detailed to logs
logger.error({
  message: err.message,
  stack: err.stack,
  path: req.path,
