...
## 🔥 BOLD DIFFERENTIATION (CRITICAL)

**Before coding, commit to a BOLD aesthetic direction:**

### The Unforgettable Question (MANDATORY)

Ask yourself: **"What's the ONE THING someone will remember about this design?"**

If you can't answer this, you're building generic UI. Stop and decide.
...
| ❌ Common Convergence | ✅ Vary Radically |
|----------------------|-------------------|
| Space Grotesk font | Different distinctive font each time |
| Purple gradients | Any color but purple |
| Dark + neon glow | Light themes, muted tones, or bold prints |
| Bento grids | Alternative layouts for each project |
| Same component patterns | Context-specific approaches |
...
### ❌ Visual Slop Patterns (AI-Generated Look)

| Pattern | Why Bad | Alternative |
|---------|---------|-------------|
| Inter/Roboto/Arial fonts | No character, AI default | Distinctive display + refined body fonts |
| Purple gradients on white | AI's default "pretty" | Commit to real color story |
...
| Evenly-spaced card grids | Cookie-cutter layout | Varied sizes, overlaps, masonry |
| Stock illustration style | Instantly recognizable as AI | Custom graphics, photography, abstract |
| "Clean and modern" as goal | Says nothing | Specific aesthetic with clear POV |
| Rounded corners everywhere | Softens into sameness | Mix sharp and soft intentionally |
| Gradient-only backgrounds | Lazy depth | Textures, patterns, layered elements |
| Generic hero sections | "Big text + CTA + image" | Unexpected compositions |

### ❌ Banned Font Families

```css
/* NEVER USE - Generic AI-slop fonts */
font-family: Inter, Arial, Roboto, system-ui, sans-serif;

/* USE INSTEAD - Distinctive typefaces */
--font-display: "Playfair Display", "Clash Display", "Fraunces", serif;
--font-body: "Source Serif 4", "Satoshi", "DM Sans", sans-serif;
