...
- Read `~/.claude/skills/antigravity/knowledge/trade-off-analysis/SKILL.md`
...
- Update `.antigravity/progress.md` with new ADR
- Update architecture section in `.antigravity/project-context.md`
