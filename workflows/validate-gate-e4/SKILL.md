...
- Read `~/.claude/skills/antigravity/knowledge/ux-polish/SKILL.md`
...
Load criteria from `~/.claude/skills/antigravity/context/gate-criteria.md` § Validation Council Gates → Gate E4.
