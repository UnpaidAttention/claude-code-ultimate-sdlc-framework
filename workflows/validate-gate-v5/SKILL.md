...
- Read `~/.claude/skills/antigravity/knowledge/intent-documentation/SKILL.md`
...
Load criteria from `~/.claude/skills/antigravity/context/gate-criteria.md` § Validation Council Gates → Gate V5.
