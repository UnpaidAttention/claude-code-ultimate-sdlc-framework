...
- Read `~/.claude/skills/antigravity/knowledge/feature-deliberation/SKILL.md`
...
Load criteria from `~/.claude/skills/antigravity/context/gate-criteria.md` § Planning Council Gates → Gate 1.5.
...
If PASS:
1. Update `.antigravity/council-state/planning/current-state.md`:
